...
function f5() {
    ...
    let bgOrange = out4.classList.contains('bg-orange');
    if (bgOrange) {
        out5.innerHTML = true;
    } else {
...
function f6() {
    ...
    out6.innerHTML = paragraph.length;
}
...
//  Task 10
// Усложним предыдущие задачи. С помощью цикла ловим на блоки .out-10 событие клик. 
...
function f11() {
    ...
    document.querySelector('.out-11').appendChild(element);
}
...
function f12() {
    ...
    element.classList.add('bg-12');
    document.querySelector('.out-12').appendChild(element);
};
...
function f13() {
let element = document.createElement('div');
element.innerHTML = 'pushMe';
element.classList.add('bg-orange');
element.onclick = f13_1;
document.querySelector('.out-13').appendChild(element);
}
...
function f14() {
    ...
    element.classList.add('bg-orange');
    document.querySelector('.out-14').append(element);
}
...
element.classList.add('bg-orange');
document.querySelector('.out-15').before(element);
}
...
function f16() {
    ...
    element.classList.add('bg-orange');
    document.querySelector('.out-16').after(element);
}
...
function f17() {
    ...
    element.classList.add('bg-orange');
    document.querySelector('.out-17').replaceWith(element);
