...
// функции выполняют наборы действий либо возвращают  свое значение
...
function multi3(q, r) {
    return q + r;
    // все что написано ниже return будет проигнорировано
}
...
document.querySelector('.f2').onclick = newFunc();
...
// Task 5
// Задача на функцию с несколькими параметрами: Напишите функцию addNumbers, которая принимает два числа в качестве аргументов и возвращает их сумму.
// Например, если функция вызывается с аргументами 3 и 5, она должна возвращать 8.
...
console.log(compareNumbers(5, 15)); 
