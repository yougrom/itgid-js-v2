...
let e1 = "3";
let f1 = 5;
document.querySelector(".out-4").textContent = e1 + f1; // При конкатенации Складываются числа как строки
...
function t10() {
  let inputField = document.querySelector(".i-10");
  let inputValue = inputField.value;
  let out = document.querySelector(".out-10");
  out.innerHTML = inputValue * 20;
  inputField.value = "";
}
...
function t11() {
  let inputField = document.querySelector(".i-11");
  let inputValue = inputField.value;
  let out = document.querySelector(".out-11");
  out.innerHTML = +inputValue + 55;
  inputField.value = "";
}
...
function t13() {
  ...
  //   out.innerHTML = Number(a) + Number(b);
  out.innerHTML = +a + +b;
}
...
function t14() {
  let inputField = document.querySelector(".i-14");
  inputField.value = "Go";
}
...
function t15() {
  let inputField = document.querySelector(".i-15");
