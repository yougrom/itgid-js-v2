...
document.querySelector(".out-8").innerHTML = "word";
...
// Task 18.
// Получите div.out-18 в переменную out18. Выведите эту переменную в консоль. Присвойте out18 значение 5 (out18 = 5). Выведите переменную в консоль.
// Изучите вывод.
...
// Task 19.
// Получите div.out-19 в переменную out19. Выведите в консоль out19. Теперь получите в эту же переменную out19 блок div c классом out-19-test.
