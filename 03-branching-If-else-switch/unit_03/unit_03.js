...
function f3() {
  ...
  if (valOne > valTwo) {
    ...
    out.innerHTML = 'Numbers are equal';
  }
}
...
function f4() {
  let birthday = +document.querySelector('.i-4').value;
...
function f7() {
  let base = +document.querySelector('.i-71').value;
  let exponent = +document.querySelector('.i-72').value;
...
function f13() {
  let inputElement = document.querySelector('.i-130');
  let inputValue = inputElement.value;
  let outputElement = document.querySelector('.out-13');
  console.log('Before conversion:', typeof inputValue);

  let numericValue = +inputValue;
  console.log('After conversion:', typeof numericValue);
  outputElement.innerHTML = typeof numericValue;
}
