...
// Callback функция это функция которая передается в качестве аргумента другой функции и которая будет вызвана внутри этой функции
...
// callback называют функцию которая передается внутрь как условие
